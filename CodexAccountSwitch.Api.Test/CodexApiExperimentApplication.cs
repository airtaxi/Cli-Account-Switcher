...
using CodexAccountSwitch.Api.Infrastructure.Http;
...
using CodexAccountSwitch.Api.Test.Infrastructure;
using System;
...
namespace CodexAccountSwitch.Api.Test;
...
public sealed class CodexApiExperimentApplication : IDisposable
{
    ...
    {
        Console.WriteLine("CodexAccountSwitch.Api.Test");
        Console.WriteLine();
