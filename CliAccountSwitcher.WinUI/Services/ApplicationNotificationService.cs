...
public sealed class ApplicationNotificationService
{
    ...
    {
        var notificationTitle = App.LocalizationService.GetLocalizedString("Notification_ExpiredAccountDetectedTitle");
    ...
    {
        var notificationTitle = App.LocalizationService.GetLocalizedString("Notification_StoreUpdateAvailableTitle");
        ...
        var notificationButton = new AppNotificationButton(App.LocalizationService.GetLocalizedString("Notification_OpenStoreButtonText")).SetInvokeUri(storeProductPageAddress);
    ...
    {
        var notificationTitle = App.LocalizationService.GetLocalizedString("Notification_UsageLowQuotaDetectedTitle");
        var usageWindowName = App.LocalizationService.GetLocalizedString("Notification_PrimaryUsageLowQuotaWindowName");
    ...
    {
        var notificationTitle = App.LocalizationService.GetLocalizedString("Notification_UsageLowQuotaDetectedTitle");
        var usageWindowName = App.LocalizationService.GetLocalizedString("Notification_SecondaryUsageLowQuotaWindowName");
        var notificationMessage = GetUsageLowQuotaNotificationMessage(accountDisplayName, usageWindowName, usageRemainingPercentage, hasAlternativeAccountOverWarningThreshold);
        ShowNotification(notificationTitle, notificationMessage, notificationAction: AccountsNavigationNotificationAction);
    }
